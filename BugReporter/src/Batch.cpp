...
namespace BugReporter
{
	...
	//Curl functionality to communicate with the Rest API, creates a Jira Issue and fills in the necessary data using JSON
	void Batch::CreateJiraIssueWithData()
	{
		m_batch << "curl ^\n";
		m_batch << "   -D- ^\n";
		m_batch << "   -H \"Authorization: Basic xxxxxxxxxxxx\" ^\n";
		m_batch << "   -X POST ^\n";
